  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8 animate-pulse">
        ...
        <div className="bg-white border border-gray-100 rounded-xl h-10 mb-6" />

        <div className="h-3 w-28 bg-gray-100 rounded mb-3" />
        {[1, 2, 3].map(i => (
          <div key={i} className="bg-white border border-gray-100 rounded-lg h-14 mb-2" />
        ))}

        <div className="h-3 w-28 bg-gray-100 rounded mb-3 mt-6" />
        {[1, 2].map(i => (
          <div key={i} className="bg-white border border-gray-100 rounded-lg h-14 mb-2" />
        ))}
      </main>
